...
function Header() {
  return (
    <div className="shadow-sm border-b bg-white sticky top-0 z-50">
        <div className="flex justify-between bg-white max-w-10xl mx-5 lg:mx-auto ">
        {/* Left */}
        ...
        <div className="flex items-center justify-end space-x-4">
          ...
          {/* <img src="https://papareact.com/3ke" alt="profile pic" className="h-10 rounded-full cursor-pointer"/> */}
        </div>
      </div>
    </div>
  )
